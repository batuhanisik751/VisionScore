...
- **Image Comparison** -- Side-by-side scoring of two images with diff highlights
...
# Compare two images
visionscore compare before.jpg after.jpg

# Compare with JSON output
visionscore compare before.jpg after.jpg --output json
